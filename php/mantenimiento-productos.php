...
$sql_select = "SELECT idProducto, productos.nombre, cantidad, stockMaximo, fechaIngreso from productos inner join  proveedor on proveedor.idProveedor = productos.idProveedor ORDER BY idProducto";
