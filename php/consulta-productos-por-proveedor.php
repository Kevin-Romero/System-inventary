...
$sql_select = "SELECT idProducto, productos.nombre, precio, proveedor.nombre as 'Proveedor', fechaIngreso from productos inner join  proveedor on proveedor.idProveedor = productos.idProveedor WHERE proveedor.idProveedor = $idProveedor GROUP BY idProducto ORDER BY idProducto";
...
<head>
    ...
    <title>SCA / Consulta de Productos / Productos pro Proveedor</title>
</head>
...
<body>
    ...
    <div class="list-container">
        ...
        <div class="header-table"> 
           ...
           <a href="consulta-productos.php" class="btn btn-dark mr-3 cancelar">Atras</a>  
