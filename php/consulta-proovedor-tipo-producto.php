...
$sql_select = "SELECT proveedor.idProveedor as 'idProveedor', proveedor.nombre as 'nombre', direccion, telefono, tipoProducto.nombre as 'tpNombre' FROM `proveedor` INNER JOIN productos on productos.idProveedor = proveedor.idProveedor inner join tipoProducto on tipoProducto.idTipoProducto = productos.idTipoProducto WHERE tipoProducto.idTipoProducto = $idTipoProducto GROUP BY proveedor.idProveedor ORDER BY proveedor.idProveedor;
";
...
$sql_select_tp = "SELECT idTipoProducto, nombre as 'tpNombre' FROM tipoProducto WHERE idTipoProducto = $idTipoProducto";
...
<body>
    ...
    <header class="nav-container">
        <div class="nav-title">
            <h2>Consulta - Productos por proveedor</h2>
        </div>
        <div class="nav">
    ...
    <?php if($result_tp >0){
        ...
        ?>
                    <h3>Tipo Producto: <?php echo $data_tp['tpNombre']; ?></h3>
