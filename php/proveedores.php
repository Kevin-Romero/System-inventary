...
<body>
    ...
    <div class="list-container">
        ...
        <div class="header-table">
            ...
            <form action="buscar-proveedor.php" method="get" enctype="multipart/form-data">
            ...
            <div class="btn-new-container">
                <button id="myBtn-proveedores" class="btn btn-success">Nuevo</button>  
            </div>
       ...
       <!-- The Modal -->
    <div id="myModal-proveedores" class="modal">
    ...
    <script>
        ...
        // Get the modal
        var modal = document.getElementById("myModal-proveedores");

        // Get the button that opens the modal
        var btn = document.getElementById("myBtn-proveedores");
