...
if($tipoBusqueda == "idTipoProducto"){

  $sql_select = "SELECT * FROM tipoProducto WHERE $tipoBusqueda LIKE '$buscar'
                  GROUP BY idTipoProducto ORDER BY idTipoProducto LIMIT 1";

}

$sql_select = "SELECT * FROM tipoProducto WHERE $tipoBusqueda LIKE '%$buscar%'
                GROUP BY idTipoProducto ORDER BY idTipoProducto";
...
<body>
    ...
    <header class="nav-container">
        <div class="nav-title">
            <h2>Mantenimiento de Tipo de Producto</h2>
        </div>
        <div class="nav">
        ...
        <div class="header-table">
          ...
          <form action="buscar-tp.php" method="get" enctype="multipart/form-data">
             ...
             <select name="tipo-busqueda" id="" class="btn btn-dark m-2" required>
              ...
              <a href="tp.php" class="btn btn-danger">Cancelar</a>
          </form>
