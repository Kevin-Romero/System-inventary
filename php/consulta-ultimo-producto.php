...
$sql_select = "SELECT idProducto, productos.nombre, precio, proveedor.nombre as 'Proveedor', fechaIngreso, caducidad from productos inner join  proveedor on proveedor.idProveedor = productos.idProveedor ORDER BY fechaIngreso desc LIMIT 1";
...
<body>
    ...
    <header class="nav-container">
        <div class="nav-title">
            <h2>El ultimo producto registrado</h2>
        </div>
        <div class="nav">
