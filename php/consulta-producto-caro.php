...
$sql_select = "SELECT idProducto, productos.nombre, precio, proveedor.nombre as 'Proveedor', fechaIngreso, caducidad from productos inner join  proveedor on proveedor.idProveedor = productos.idProveedor ORDER BY precio desc LIMIT 1";
...
<body>
    ...
    <header class="nav-container">
        <div class="nav-title">
            <h2>El producto mas caro registrado</h2>
        </div>
        <div class="nav">
