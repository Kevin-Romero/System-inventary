...
<body>
    ...
    <div class="form-container mt-5">
            ...
            <form action="validar-modificar-tp.php" method="post" enctype="multipart/form-data">
                <div class="input-modificar-container">
                    <label for="id">Clave:</label> 
                    <input type="text" class="form-control" name="id" id="id" value="<?php echo $data['idTipoProducto']; ?>" disabled>
                    <input type="text" value="<?php echo $data['idTipoProducto']; ?>" name="idTipoProducto" id="idProveedor">
                    <label for="nombre">Nombre:</label>
                    <input type="text" class="form-control" name="nombre" id="nombre" value="<?php echo $data['nombre']; ?>">
                
                    <input type="submit" class="btn btn-warning" value="Guardar">
                    <a href="tp.php" class="btn btn-danger mr-3">Cancelar</a>
